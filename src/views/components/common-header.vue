<template>
 ...
 <el-menu background-color="#0050a2" router
  text-color="#CCE1FE"
  active-text-color="#fff" class="el-menu-demo el-menu-tz menu-main-box" mode="horizontal" @select="handleSelect">
    <div class="logo">
      <img src="../../assets/img/logo.png" class="">
      <span>台州市县综合气象业务一体化平台</span></div>
    <template v-for="item in menuInfo">
      <el-menu-item :key="item.id" v-if='!item.children' :index="item.path">{{item.name}}</el-menu-item>
