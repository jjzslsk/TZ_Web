...
<el-aside class="common-left">
    <el-card class="box-card" shadow="never">
        ...
        <div class="text">
            <div class="tree">
                <c-tree :remote="remote" :data='data' :searchText='searchText' :defaultExpandAll='defaultExpandAll' :keys-expanded-default="keysExpandedDefault" :key-current-node="keyCurrentNode" @select-item="data=>$emit('select-item',data)" @click-item="data=>$emit('click-item',data)" @select-path="onTreeSelectPath">
                </c-tree>
            </div>
