            ...
            <div class="form-item">
              ...
              <div class="item-content">
                ...
                <el-form-item label=" 产品名称">
                  <el-input size="small" v-model="InfoForm.name" disabled></el-input>
                </el-form-item>
                <el-form-item label=" 产品类型">
                  <el-input size="small" v-model="InfoForm.type" disabled></el-input>
                </el-form-item>
              ...
              <div class="item-content">
                ...
                <el-form-item label=" 制作页面">
                  <el-input size="small" v-model="InfoForm.targetPath"></el-input>
                </el-form-item>
                <el-form-item label="发布方式">
                  <div class="checkbox-box">
                    <el-checkbox-group v-model="InfoForm.publishChannel" size="mini">
        ...
        <div class="content-box" v-if="editState">
          ...
          <el-form ref="form" class="right-top-form" :model="formModel" label-width="40px">
            <div class="select-time">
              <div class="item">
                <el-select size="mini" v-model="formModel.makeYear" placeholder="年">
                  <el-option label="任意年" value="9999"></el-option>
              ...
              <div class="item">
                <el-select size="mini" v-model="formModel.makeMonth" placeholder="月">
                  <el-option label="任意月" value="99"></el-option>
              ...
              <div class="item">
                <el-select size="mini" v-model="formModel.makeDay" placeholder="日">
                  <el-option label="任意日" value="99"></el-option>
              ...
              <div class="item">
                <el-select size="mini" v-model="formModel.makeHour" placeholder="时">
                  <el-option label="任意时" value="99"></el-option>
              ...
              <div class="item">
                <el-select size="mini" v-model="formModel.makeMinute" placeholder="分">
                  <el-option label="00" value="00"></el-option>
                  <el-option label="05" value="05"></el-option>
                  <el-option label="10" value="10"></el-option>
                  <el-option label="15" value="15"></el-option>
            ...
            <el-col :span="18">
                <el-checkbox-group v-model="formModel.makeWeek">
                  ...
                  <el-col :span="6">
                    <el-button type="primary" size="mini" @click="itemAdd()" >添加</el-button>
                  </el-col>
                </el-form-item>
          </el-form>
          <el-form ref="form" class="right-bottom-form" :model="formModel" label-width="74px">
              ...
              <div class="title">
                <div class="text">
                  <!-- {{item.time}} -->
                  {{modelList[index].makeYear == '9999'? '任意年':modelList[index].makeYear+'年'}}
                  {{modelList[index].makeMonth == '99'? '任意月':modelList[index].makeMonth+'月'}}
                  {{modelList[index].makeDay == '99'? '任意日':modelList[index].makeDay+'日'}}
                  {{modelList[index].makeHour == '99'? '任意时':modelList[index].makeHour+'时'}}
              ...
              <div class="file-date">
                  <el-form-item label="圆角选择">
                    <el-select size="mini" v-model="modelList[index].state" placeholder="请选择">
                      <el-option
                  ...
                  <el-form-item label="限制字数">
                    <el-input size="mini" placeholder="请输入" v-model="modelList[index].number"></el-input>
                  </el-form-item>
                <el-form-item label="延迟时间">
                  <el-input size="mini" type="number" v-model="modelList[index].delayMinute" placeholder="分钟"></el-input>
                </el-form-item>
              </div>
                <el-form-item label="文件名称">
                  <el-input size="mini" v-model="modelList[index].fileName"></el-input>
                </el-form-item>
              <el-form-item label="选择模板">
               <el-input size="mini" :disabled="visible" v-model="modelList[index].templateName" @click.native="inputEvent(item,index)" autocomplete="off"></el-input>
                <!-- <el-select size="mini" v-model="modelList[index].templateId" placeholder="选择模板">
    ...
    onTab() {
        ...
        requestProductUserList({orgId:this.loginInfo.orgId,productInfoId:this.lastItemClicked.id,channelCodes:publishChannels.toString()}).then(res=>{
            ...
            if(res.data){
              ...
              this.tabsShowUserValue = res.data[0].id
            }
        })
    },
      submitUserSuccess(){},
    ...
    handleNodeClick(data) {
      ...
      if(data.treeType == 'product'){
        ...
        requestProductInfoTreeItem({id:data.id}).then(res=>{
          ...
          if(res.data.list[0].publishChannel == null || res.data.list[0].publishChannel == '' || res.data.list[0].publishChannel == []){
            this.InfoForm.publishChannel = []
          }else{
            this.InfoForm.publishChannel = res.data.list[0].publishChannel
          }
