<template>
<table-block ref="table" :remote="remote" :data='data' :height="height" :hidePagination="hidePagination" :formatPayload="formatPayloadInner" :span-method="spanMethod" :row-class-name="rowClassName" @current-change="onCurrentChange">
